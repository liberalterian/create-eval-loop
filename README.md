...
Copy the contents of this plugin into your Claude plugin/skills workspace, or copy only the `skills/` folders into your project/user `.claude/skills/` directory.
